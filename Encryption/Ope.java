...
public class Ope {
    ...
    public Ope() {
        ...
        this.inRange = new ValueRange(new BigInteger("2").pow(32).negate(),new BigInteger("2").pow(32));
        this.outRange = new ValueRange(new BigInteger("2").pow(48).negate(),new BigInteger("2").pow(48));
    ...
    public BigInteger encrypt(BigInteger ptxt) {
        ...
        return this.encryptRecursive(ptxt, this.inRange, this.outRange); // error
    }
    ...
    private BigInteger encryptRecursive(BigInteger ptxt, ValueRange inRange, ValueRange outRange) {
        ...
        BigInteger x = sampleHGD(inRange, outRange, mid, coins); //error
    ...
    private static BigInteger sampleHGD(ValueRange inRange, ValueRange outRange,
        ...
        BigInteger inSampleNum = Hgd.rhyper(nSampleIndex, inSize, outSize, coins); //error
